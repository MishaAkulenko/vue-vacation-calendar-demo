<template>
    <header>
        <div class="vacation-info">
            {{ $t('dashboard.avail_days', {days:availVacationDays, dayLocale: getDateLocale(availVacationDays, 'days')}) }}
        </div>
...
<script>
    ...
    import HeaderProfileSettingsComponent from './HeaderProfileSettingsComponent.vue';
