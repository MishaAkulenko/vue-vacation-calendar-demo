<template>
    <div class='profile-settings-wrapper'>
        ...
        <ul class='settings-actions-list'>
            <li>
                <router-link :to='routes.profile' class='settings settings-actions-item'>{{'user_settings.settings' | translate}}</router-link>
            </li>
            <li class='logout settings-actions-item' @click="doLogout">{{'user_settings.logout' | translate}}</li>
        </ul>
    </div>
</template>
